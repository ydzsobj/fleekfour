...
function toDivide(money){
    var value=(money||0)/100;
...
//tips 
function tipErr (data){
	var content = '<div id="myAlert" style="z-index: 11;top: 50%;position: fixed;left: 40%;" class="alert alert-danger fade in"><span class="glyphicon glyphicon-exclamation-sign"></span>  <strong>'+data+'</strong>  </div>'
	$('body').append(content);
	setTimeout(function(){$("#myAlert").remove()},3000)
 }
